...
ARG TEST_DUMB_NGINX_SERVER_HOST
ARG TEST_APP_NODEJS_SERVER_PORT
ARG TEST_SMART_NGINX_SERVER_HOST
ARG TEST_PRERENDERER_NODEJS_SERVER_PORT

ENV TEST_DUMB_NGINX_SERVER_HOST=$TEST_DUMB_NGINX_SERVER_HOST
ENV TEST_APP_NODEJS_SERVER_PORT=$TEST_APP_NODEJS_SERVER_PORT
ENV TEST_SMART_NGINX_SERVER_HOST=$TEST_SMART_NGINX_SERVER_HOST
...
RUN sed -i "s/TEST_DUMB_NGINX_SERVER_HOST/${TEST_DUMB_NGINX_SERVER_HOST}/g" /etc/nginx/conf.d/default.conf
RUN sed -i "s/TEST_APP_NODEJS_SERVER_PORT/${TEST_APP_NODEJS_SERVER_PORT}/g" /etc/nginx/conf.d/default.conf
RUN sed -i "s/TEST_SMART_NGINX_SERVER_HOST/${TEST_SMART_NGINX_SERVER_HOST}/g" /etc/nginx/conf.d/default.conf
