...
ARG TEST_COMMON_NGINX_CONTAINER_HOST
...
ENV TEST_COMMON_NGINX_CONTAINER_HOST=$TEST_COMMON_NGINX_CONTAINER_HOST
...
RUN sed -i "s/TEST_COMMON_NGINX_CONTAINER_HOST/${TEST_COMMON_NGINX_CONTAINER_HOST}/g" /etc/nginx/conf.d/default.conf
