...
COPY ./docker/apache/2.2/httpd.conf /usr/local/apache2/conf/httpd.conf
COPY ./docker/apache/2.2/httpd-vhosts.conf /usr/local/apache2/conf/extra/httpd-vhosts.conf
